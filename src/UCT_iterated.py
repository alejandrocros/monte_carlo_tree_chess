...
from board_functions import ChessBoard, add, create_board, look, random_move
...
if __name__ == '__main__':
    ...
    parser.add_argument("-s", "--save_results", help="wether to save the results or not", type=bool, default=False)
